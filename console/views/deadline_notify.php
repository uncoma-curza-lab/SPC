...
<body>
	<div class="container">
		...
		<p>Por medio de la presente, nos dirigimos a ustedes con el fin de recordarles que el plazo de entrega de los programas de cátedra correspondientes al año académico en curso finaliza el día <?= date_create($deadline)->format('d-m-Y') ?>. De acuerdo a la normativa vigente, la presentación de los programas es obligatoria y su cumplimiento es requisito indispensable para el correcto desarrollo de las actividades académicas en la Universidad Nacional del Comahue.</p>
		<p>El Sistema de programas de cátedra de nuestra institución es una herramienta fundamental para la planificación y organización de las actividades docentes, actividades docentes, la comunicación con los/as estudiantes y como documento a presentar ante otras instituciones de Educación Superior en caso de equivalencias y pases. En este sentido, les instamos a que completen y envíen sus programas a la brevedad, a fin de asegurar el cumplimiento de los objetivos académicos previstos.</p>
