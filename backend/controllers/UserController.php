...
class UserController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            if(empty($model->auth_key) || !$model->auth_key){
                $model->auth_key='';
            }
            if(!empty($model->nuevopassword)){
                //$model->password_hash = Yii::$app->getSecurity()->generatePasswordHash($model->nuevopassword);
                $model->password=$model->nuevopassword;
            }
            if($model->save()){
